...
function sendMessage(text) {
    ...
    try {
        ...
        const input = getElementByXpath(`/html/body/div[1]/div[1]/div[1]/div[4]/div[1]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div[2]`);

        input.innerHTML = text;
        input.dispatchEvent(new Event('input', {bubbles: true}));
        setTimeout(()=>{
            getElementByXpath(`/html/body/div[1]/div[1]/div[1]/div[4]/div[1]/footer/div[1]/div/span[2]/div/div[2]/div[2]/button`).click();
        }, 100)
